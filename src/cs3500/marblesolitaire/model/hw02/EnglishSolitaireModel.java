...
public class EnglishSolitaireModel implements MarbleSolitaireModel {
  ...
  public EnglishSolitaireModel() {
    // TODO: Reduce duplicate code across constructors
    this.armThickness = 3;
    this.sRow = 3;
    this.sCol = 3;
  ...
  /**
   * Works just like {@link EnglishSolitaireModel#isValidSlot(int, int, int)} except
   * {@code armThickness} defaults to the board's {@link EnglishSolitaireModel#armThickness}.
   *
   * @see EnglishSolitaireModel#isValidSlot(int, int, int)
   */
