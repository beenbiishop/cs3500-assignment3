...
public class EnglishSolitaireModelTest {
  ...
  public void testOneArgumentConstructor() {
    assertEquals(SlotState.Empty, armThickness3.getSlotAt(3, 3));
    assertEquals(SlotState.Invalid, armThickness3.getSlotAt(0, 0));
    assertEquals(SlotState.Invalid, armThickness3.getSlotAt(1, 6));
    assertEquals(SlotState.Marble, armThickness3.getSlotAt(3, 0));
    assertEquals(SlotState.Marble, armThickness3.getSlotAt(5, 4));
  }
  ...
  public void testThreeArgumentConstructor() {
    ...
    assertEquals(SlotState.Invalid, armThickness5EmptySlot4by4.getSlotAt(0, 0));
    assertEquals(SlotState.Invalid, armThickness5EmptySlot4by4.getSlotAt(3, 9));
    assertEquals(SlotState.Marble, armThickness5EmptySlot4by4.getSlotAt(5, 5));
    assertEquals(SlotState.Marble, armThickness5EmptySlot4by4.getSlotAt(7, 4));
  }
  ...
  public void testGetSlotAt() {
    Assert.assertEquals(SlotState.Empty, new EnglishSolitaireModel(1).getSlotAt(0, 0));
    assertEquals(SlotState.Invalid, new EnglishSolitaireModel(5).getSlotAt(1, 1));
    assertEquals(SlotState.Marble, armThickness3.getSlotAt(2, 0));
  }
  ...
  public void testMove() {
    ...
    assertSame(emptySlot5by3.getSlotAt(4, 5), SlotState.Empty);
    assertSame(emptySlot5by3.getSlotAt(4, 4), SlotState.Empty);
    assertSame(emptySlot5by3.getSlotAt(4, 3), SlotState.Marble);
  }
